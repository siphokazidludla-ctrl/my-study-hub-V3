...
const CASE_GUIDES: Record<string, {
  ...
  'ikm-digital-transformation': {
    topic: 'Knowledge management, tacit knowledge and information governance',
    questionType: 'Case analysis: diagnose and recommend (Analyse / Recommend)',
    relevantFormulas: ['SECI model', 'KM cycle', 'Information governance'],
    relevantUnits: ['ikm-3', 'ikm-5', 'ikm-10'],
    steps: [
      'Step 1: Classify the question as a knowledge-management and change problem, not a pure technology problem.',
      'Step 2: Extract the case facts: new digital systems introduced, employees use informal workarounds, knowledge stays trapped in departments (silos).',
      'Step 3: Diagnose the root causes: tacit knowledge is not being externalised, weak adoption of the new system, no governance over who owns information, and a culture that does not reward sharing.',
      'Step 4: Apply the KM cycle (create, capture, share, apply) to show where the organisation is failing - mainly capture and share.',
      'Step 5: Apply the SECI model - the firm is stuck in socialisation (informal workarounds) and never reaches externalisation and combination, so knowledge is never converted into shared explicit assets.',
      'Step 6: Apply information governance - assign ownership, standards and accountability for information so it is no longer trapped in departments.',
      'Step 7: Recommend solutions: externalise tacit knowledge into the system through templates and communities of practice, drive adoption through training and incentives, and build a sharing culture with leadership sponsorship.',
      'Step 8: Add change-management actions (vision, sponsorship, communication, reinforcement) so the new system is actually used.',
      'Step 9: Build the exam paragraph linking diagnosis to recommendations.',
      'Step 10: Add critical judgement on culture, incentives and the limits of technology.',
    ],
    examParagraph: 'This case is fundamentally a knowledge-management and change problem rather than a technology failure. The symptoms - informal workarounds, weak adoption and departmental knowledge silos - show that the organisation captures little of its tacit knowledge and never externalises it into shared, explicit assets. Using the SECI model, the firm remains stuck in socialisation and never progresses to externalisation and combination, so know-how is never converted into organisation-wide resources. The remedy combines information governance (clear ownership, standards and accountability), deliberate externalisation of tacit knowledge through templates and communities of practice, and a change-management programme - leadership sponsorship, training, communication and incentives - that builds a sharing culture and drives genuine adoption of the new systems (Dalkir, 2022; Laudon and Laudon, 2023).',
    criticalJudgement: [
      'Technology alone never creates knowledge management; culture, incentives and governance determine success.',
      'Externalising tacit knowledge is difficult and time-consuming, and some tacit expertise resists codification.',
      'Incentives must reward sharing, otherwise staff continue to hoard knowledge as personal value.',
      'Change must be managed deliberately; without sponsorship and reinforcement, workarounds return.',
    ],
  },
  'mm-brand-repositioning': {
    topic: 'STP, brand equity and integrated digital communication',
    questionType: 'Case analysis: diagnose and recommend (Analyse / Evaluate / Recommend)',
    relevantFormulas: ['STP', 'Brand equity', 'Customer journey', 'IMC'],
    relevantUnits: ['mm-4', 'mm-9'],
    steps: [
      'Step 1: Classify the question as a positioning and brand-relevance problem, not simply a social-media problem.',
      'Step 2: Extract the case facts: high awareness but loss of younger customers, outdated positioning, and digital communication that feels dated.',
      'Step 3: Apply Segmentation, Targeting and Positioning (STP): identify the younger segment being lost and clarify what value the brand should promise them.',
      'Step 4: Diagnose the value mismatch: high awareness shows reach is not the problem; the issue is that the positioning and value proposition no longer resonate with the target segment.',
      'Step 5: Map the customer journey to find where younger customers disengage (awareness is strong, but consideration, conversion and loyalty break down).',
      'Step 6: Apply brand-equity thinking: rebuild perceived relevance, associations and loyalty for the target segment.',
      'Step 7: Use integrated marketing communications (IMC) to align a refreshed positioning consistently across the digital channels the segment actually uses.',
      'Step 8: Recommend: reposition first, redefine the value proposition, then realign communication and channels - in that order.',
      'Step 9: Build the exam paragraph linking strategy (positioning and value) to tactics (channels and content).',
      'Step 10: Add critical judgement on the risk of alienating existing customers and the need to measure results.',
    ],
    examParagraph: 'The core issue is strategic fit between the target segment, the value proposition and the communication channels, not merely a lack of social-media activity. High awareness shows that reach is adequate; the brand is losing younger customers because its positioning and value proposition no longer feel relevant to them. The correct sequence is to use STP to re-target and reposition for the younger segment, redefine the value the brand promises, and only then realign digital communication through an integrated marketing-communications approach so the refreshed positioning is delivered consistently on the channels that segment actually uses. Brand-equity measures and customer-journey mapping then track whether relevance, consideration and loyalty recover (Kotler and Armstrong, 2020).',
    criticalJudgement: [
      'Adding social-media activity without fixing positioning treats a symptom, not the cause.',
      'Repositioning for younger customers risks alienating the existing base, so the trade-off must be managed.',
      'Awareness is not the problem; conversion and loyalty are, so metrics must focus there.',
      'A consistent value proposition across channels matters more than the volume of posts.',
    ],
  },
};
