...
export const REFERENCES: Record<string, Reference> = {
  ...
  'Kotler and Keller (2016)': { inText: 'Kotler and Keller (2016)', full: 'Kotler, P. and Keller, K.L. (2016). A Framework for Marketing Management. 6th ed. Harlow: Pearson.', tier: 'Prescribed Textbook' },
